...
if not LOCAL_TEST:
    ...
    test_predictions[['TransactionID','isFraud']].to_csv('kernel1_remodel7/submission7.csv', index=False)

# %%
## LOCAL_TEST = True
# auc→0.9198707367159703(ver4+kurtを追加))(今までのmax→0.9211773468405661)
# auc→0.9212204438396412(ver4+skewを追加))(今までのmax→0.9211773468405661)更新！
# auc→0.9230216935319279(ver4+skew+median系を追加))(今までのmax→0.9211773468405661)
