...
for df in [train_df, test_df]:
    ...
    # D9 column(いろいろ細かな数字をまとめて2値化してしまった)
...
# trainだけでどうやって置換するべきかを学んで、それをtestにも割り当てている。
# まず、これをcvでやるか
...
# (even if features importances are telling contrariwise) # 特徴重要度が大事だと言っても取引金額はノイズらしい...
...
# %%
## LOCAL_TEST = True
# max auc→0.9201838362280063
# feat_imp
# 473   1470                         D8
# 474   1482    uid_TransactionAmt_mean
# 475   1494                 uid_fq_enc
# 476   1606                      id_20
# 477   1854                uid2_fq_enc
# 478   1866                         D2
# 479   1879                        D10
# 480   1886                         D4
# 481   1900                        C13
# 482   1945                      id_02
# 483   1958       P_emaildomain_fq_enc
# 484   2093   card2_TransactionAmt_std
# 485   2231               card1_fq_enc
# 486   2270   card1_TransactionAmt_std
# 487   2347                      dist1
# 488   2587               card2_fq_enc
# 489   2818  card2_TransactionAmt_mean
# 490   2831                        D15
# 491   2924                   uid_DT_M
# 492   3084                   uid_DT_W
# 493   3236  card1_TransactionAmt_mean
# 494   3363               addr1_fq_enc
# 495   3364                      card2
# 496   3805    uid3_TransactionAmt_std
# 497   3952   uid3_TransactionAmt_mean
# 498   4025                      addr1
# 499   4052                   uid_DT_D
# 500   4150                uid3_fq_enc
# 501   5291                      card1
# 502   5696             TransactionAmt
## LOCAL_TEST = False
# max auc→0.9746..
