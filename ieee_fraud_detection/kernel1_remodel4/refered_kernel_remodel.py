...
# %%
## LOCAL_TEST = True
# auc→0.9211773468405661(meanとstdをとるのを増やすid_02とD15)(今までのmax→0.9207041589252237)更新！

# feat_imp
# 501   1596              uid_id_02_std
# 502   1656                        D10
# 503   1674                        C13
# 504   1723       P_emaildomain_fq_enc
# 505   1731                         D2
# 506   1740           card2_id_02_mean
# 507   1841              card1_D15_std
# 508   1844             card1_D15_mean
# 509   1876            card2_id_02_std
# 510   1937  card1_TransactionAmt_mean
# 511   1999                      id_02
# 512   2043                      card2
# 513   2091                   uid_DT_M
# 514   2094           card1_id_02_mean
# 515   2132                      dist1
# 516   2207            card1_id_02_std
# 517   2416               addr1_fq_enc
# 518   2420                        D15
# 519   2623                uid3_fq_enc
# 520   2670                   uid_DT_W
# 521   2720    uid3_TransactionAmt_std
# 522   2840   uid3_TransactionAmt_mean
# 523   2964                      addr1
# 524   3271              uid3_D15_mean
# 525   3386                   uid_DT_D
# 526   3415               uid3_D15_std
# 527   3448            uid3_id_02_mean
# 528   3655                      card1
# 529   3775             uid3_id_02_std
# 530   5077             TransactionAmt
# 
## LOCAL_TEST = False
# max auc(lb)→0.9490(最高値)
# max auc(cvの)→0.97651
